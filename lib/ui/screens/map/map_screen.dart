...
class MapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) =>
          MapViewModel(stationsRepository: context.read<StationsRepository>()),
      child: _MapScreenView(onProfileTap: onProfileTap),
    );
  }
}
...
class _MapScreenView extends StatefulWidget {
  ...
  const _MapScreenView({required this.onProfileTap});
...
class _MapScreenViewState extends State<_MapScreenView> {
  ...
  Widget build(BuildContext context) {
    ...
    final stations = viewModel.stations.data ?? [];
