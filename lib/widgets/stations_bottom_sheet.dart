...
import 'package:velo_pp/core/constants/station_model.dart';
...
class StationsBottomSheet extends StatelessWidget {
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: _buildStationCard(station, isSelected),
                );
              },
            ),
          ),
  ...
  Widget _buildStationCard(Station station, bool isSelected) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${station.bikes} bikes • ${station.address}',
